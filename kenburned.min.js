...
;(function($, undefined){
    ...
    $.fn.kenburned = function(options) {
        ...
        var zoom_level = 1 / (options.zoom || 1.2);
        ...
        var frames_per_second = options.frames_per_second || 40;
        var frame_time = (1 / frames_per_second) * 300;
        ...
        function render_image(image_index, anim, fade) {
            ...
            if(++load_counter === 1) {
                ...
                $canvas.hide().fadeIn(500, function() {});
            }
